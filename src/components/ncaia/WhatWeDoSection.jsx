...
import {
  Globe, Music, Sparkles, Award, Heart, Handshake, Users, GraduationCap,
} from 'lucide-react';
import useScrollAnimation from '@/hooks/useScrollAnimation';
import { aboutPageContent } from '@/content/aboutContent';

const { whatWeDo } = aboutPageContent;
const iconMap = { Globe, Music, Sparkles, Award, Heart, Handshake, Users, GraduationCap };
