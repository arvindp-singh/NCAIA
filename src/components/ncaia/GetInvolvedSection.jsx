...
const iconMap = { Users, HandHeart, Handshake, CalendarDays };
    ...
    <section id="getinvolved" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-white/80 text-lg max-w-2xl mx-auto mb-14">{getInvolved.subtitle}</p>
        </motion.div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {getInvolved.actions.map((action, i) => {
